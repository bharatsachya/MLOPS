...
def corelation_among_numeric_feature(df, cols):
    numeric_col = df[cols]
...
if __name__ == "__main__":
    capped_data = pd.read_csv("E:\Regression\ols-regression-challenge-data\capped_data.csv")
    ...
    corr_features = corelation_among_numeric_feature(capped_data, capped_data.columns)
    print(corr_features)
